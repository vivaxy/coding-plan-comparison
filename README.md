...
- **`web/scripts/fetch-plans/`** — Refreshes `web/src/data/plans.json` by scraping vendor pricing pages. Run manually; see [web/scripts/fetch-plans/README.md](web/scripts/fetch-plans/README.md).
